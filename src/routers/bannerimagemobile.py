...
from src.models.bannerimagemobile import ImageModel
from src.auth_dependencies import verify_role

banner_image_router_for_mobile = APIRouter()
...
@banner_image_router_for_mobile.post("/upload-image")
...
@banner_image_router_for_mobile.get("/images", response_model=List[dict])
...
@banner_image_router_for_mobile.get("/images/{image_id}", response_model=dict)
...
@banner_image_router_for_mobile.put("/update_image/{image_id}")
...
@banner_image_router_for_mobile.delete("/delete_image/{image_id}")
